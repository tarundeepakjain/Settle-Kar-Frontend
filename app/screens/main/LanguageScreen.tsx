...
export default function LanguageScreen() {
  ...
  const handlePress = (language: string) => {
    ...
    // Here you would add the logic to change the app's language
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.optionsSection}>
          <TouchableOpacity style={styles.optionButton} onPress={() => handlePress('English')}>
            <Text style={styles.optionText}>English</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.optionButton} onPress={() => handlePress('Spanish')}>
            <Text style={styles.optionText}>Spanish</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.optionButton} onPress={() => handlePress('Hindi')}>
            <Text style={styles.optionText}>Hindi</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.optionButton} onPress={() => handlePress('Gujarati')}>
            <Text style={styles.optionText}>Gujarati</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.optionButton} onPress={() => handlePress('French')}>
